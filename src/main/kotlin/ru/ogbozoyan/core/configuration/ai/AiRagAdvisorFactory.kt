...
class AiRagAdvisorFactory(
    ...
    @Value("\${app.advisor.rag.prompt.default-user-text-advice}") private val DEFAULT_USER_TEXT_ADVISE: String,
    @Value("\${app.advisor.rag.prompt.default-user-text-advice-ru}") private val DEFAULT_USER_TEXT_ADVISE_RU: String,
